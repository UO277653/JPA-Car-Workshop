...
import uo.ri.cws.application.service.paymentmean.crud.command.FindMechanicByClientId;
import uo.ri.cws.application.service.paymentmean.crud.command.FindPaymentMeanById;
...
public class PaymentmeanCrudServiceImpl implements PaymentMeanCrudService {
	...
	public List<PaymentMeanDto> findPaymentMeansByClientId(String id) throws BusinessException {
		return executor.execute(new FindMechanicByClientId(id));
	}
